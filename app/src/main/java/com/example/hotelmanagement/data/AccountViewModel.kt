...
import com.example.hotelmanagement.models.Account
...
class AccountViewModel(var navController: NavController, var context: Context) {
    ...
    fun addAccount(name:String, email:String, title:String, check: String ,filePath: Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var account = Account(name,title,email,check,imageUrl,accountId)
